...
\begin{document}
	...
	\frame{\frametitle{Conclusion}
		\begin{itemize}
			\item Unstable graphs : are the ones that changes class by adding or removing an edge.
			\item  Experiments on the revealing action graph yield consistent results with $|\alpha - \delta|$ high and random losses.
		\end{itemize}
	}
